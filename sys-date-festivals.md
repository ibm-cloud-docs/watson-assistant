...
The following sections list the holidays that [`@sys-date`](/docs/watson-assistant?topic=watson-assistant-system-entities#system-entities-sys-date) recognizes for different locales.
...
{: caption="US English holidays" caption-side="bottom"}
...
| Boxing Day | `boxing` |
| New Year's Eve | `newyearseve` |
{: caption="Canadian holidays" caption-side="bottom"}
...
{: caption="Brazilian holidays" caption-side="bottom"}
...
{: caption="British English holidays" caption-side="bottom"}
...
| New Year's Eve | `newyearseve` |
{: caption="Czech holidays" caption-side="bottom"}
...
| New Year's Eve | `newyearseve` |
{: caption="Dutch holidays" caption-side="bottom"}
...
| Christmas Day | `christmasday` |
| New Year's Eve | `newyearseve` |
{: caption="French holidays" caption-side="bottom"}
...
| Whit Sunday (Most regions) | `whitsunday` |
| New Year's Eve | `newyearseve` |
{: caption="German holidays" caption-side="bottom"}
...
| Labor Day / May Day | `laborday` |
| New Year's Eve | `newyearseve` |
{: caption="Italian holidays" caption-side="bottom"}
...
| Christmas Day | `christmasday` |
| New Year's Eve | `newyearseve` |
{: caption="Portuguese holidays" caption-side="bottom"}
...
| New Year's Eve | `newyearseve` |
{: caption="Spanish holidays" caption-side="bottom"}
...
{: caption="Arabic holidays" caption-side="bottom"}
...
{: caption="Hebrew holidays" caption-side="bottom"}
...
{: caption="Simplified Chinese holidays" caption-side="bottom"}
...
| Mid-Autumn Festival | `midautumnfestival` |
| National Day | `nationalday` |
{: caption="Traditional Chinese holidays" caption-side="bottom"}
...
| December 31 Bank Holiday | `december31bankholiday` |
{: caption="Japanese holidays" caption-side="bottom"}
...
{: caption="Korean holidays" caption-side="bottom"}
