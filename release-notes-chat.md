...
- The experience of connecting to a human agent has also been improved – to make it more clear how a user requests an agent, ends the conversation, and flips back to start chatting with the bot.
- There are also improvements and fixes to the animations for the web chat panels to make the whole experience more seamless and cohesive.
