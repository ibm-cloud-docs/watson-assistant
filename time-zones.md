...
The following list of supported time zones can be used with the time zone functions for the [@sys-date and @sys-time entities](/docs/watson-assistant?topic=watson-assistant-system-entities#system-entities-sys-date-time).
{: shortdesc}
...
|               PRT              |                PST               |
|               SST              |                VST               |
{: caption="Supported time zones" caption-side="bottom"}
