...
## Procedures to set post-message webhooks for each deployment type

Select the deployment type of {{site.data.keyword.conversationshort}} you use to see the steps for the post-message webhook configuration:
...
This section covers the procedure to define, test, and remove post-message webhooks for **[IBM Cloud Pak for Data]{: tag-cp4d}**:

- [**Webhook configuration**](#post-procedure-cp4d)
- [**Configuring webhook error handling for postprocessing**](#post-error-handling-cp4d)
- [**Testing the webhook**](#post-testing-cp4d)
- [**Troubleshooting the webhook**](#post-troubleshoot-cp4d)
- [**Example request body**](#post-example-request-cp4d)
- [**Example 1**](#post-example-1-cp4d)
- [**Example 2**](#post-example-2-cp4d)
- [**Removing the webhook**](#post-remove-cp4d)

This section covers the procedure to define, test, and remove post-message webhooks for **[IBM Cloud Pak for Data]{: tag-cp4d} - classic experience**:

- [**Webhook configuration**](#post-procedure-cp4d-classic)
...
This section covers the procedure to define, test, and remove post-message webhooks for **{{site.data.keyword.conversationshort}}**:

- [**Webhook configuration**](#post-procedure-watson-assistant)
...
This section covers the procedure to define, test, and remove post-message webhooks for **{{site.data.keyword.conversationshort}} - classic experience**:

- [**Webhook configuration**](#post-procedure-watson-assistant-classic)
...
1. In the **Synchronous event**, select from one of the following options:
   ...
   For more information see, [Configuring webhook error handling for postprocessing](#post-error-handling-cp4d).
...
This example shows how to translate a message response back to the customer's language. It works only if you perform the steps in [Example 2](/docs/watson-assistant?topic=watson-assistant-webhook-pre#pre-example-2-cp4d) to define a pre-message webhook that translates the original message into English.
...
This example shows how to translate a message response back to the customer's language. It works only if you perform the steps in [Example 2](/docs/watson-assistant?topic=watson-assistant-webhook-pre#pre-example-2-cp4d-classic) to define a pre-message webhook that translates the original message into English.
...
This example shows how to translate a message response back to the customer's language. It works only if you perform the steps in [Example 2](/docs/watson-assistant?topic=watson-assistant-webhook-pre#pre-example-2-watson-assistant) to define a pre-message webhook that translates the original message into English.
...
This example shows how to translate a message response back to the customer's language. It works only if you perform the steps in [Example 2](/docs/watson-assistant?topic=watson-assistant-webhook-pre#pre-example-2-watson-assistant-classic) to define a pre-message webhook that translates the original message into English.
