...
In the **Connect your search provider** section of the **Milvus** window, provide the following fields from {{site.data.keyword.lakehouse_short}} to enable your assistant to connect to your Milvus instance:
...
## Ingest data into the Milvus vector database through watsonx.ai 
{: #ingest-data-milvus}
...
After you connect Milvus, you can configure how the search response displays. In the **Configure result content** section, provide the following fields to map the title, body, and URL to the search response:
...
For more information on filter expression examples, see
