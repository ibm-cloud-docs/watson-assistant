...
- **Display name**: Set a display name to overwrite the action title that appears as the button text in disambiguation. To enable disambiguation, see [Asking clarifying questions](/docs/watson-assistant?topic=watson-assistant-understand-questions#understand-questions-ask-clarifying-question).

- **Add example phrases**: Enter phrases that your customer might use to start this action. The more phrases you enter, the better your assistant recognizes what the customer wants.
...
1. Click the **Display name (optional)** field to change the action title that the user sees.

## Searching and filtering actions

If you want to search for an action, do the following steps:

1. Click on the search bar on the **Actions** page, and enter the action name.

1. Click the **filter** icon ![Filter icon](images/filter.png) to filter by **Subaction**, **Extension**, or **Variable**.
