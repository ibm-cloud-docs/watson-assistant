...
| --- | --- | --- |
| 5.4.0 | {{site.data.keyword.IBM_notm}} Software Hub 5.4.x | [Installing 5.4.0](https://www.ibm.com/docs/en/software-hub/5.4.x?topic=assistant-installing){: external}|
...
| --- | --- | --- |
| 5.4.0| 5.4.x | 4.16, 4.18, 4.19, 4.20, or 4.21 |
| 5.3.1 Patch 5 | 5.3.x | 4.14, 4.16, 4.17, 4.18, 4.19 or 4.20 |
