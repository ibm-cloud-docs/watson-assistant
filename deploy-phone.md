...
You must have Manager role access to the instance and Viewer role access to the resource group. For more information about access levels, see [Managing access](/docs/watson-assistant?topic=watson-assistant-access-control).
{: note}
