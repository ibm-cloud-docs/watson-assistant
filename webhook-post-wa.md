...
# Calling a service after processing a message for {{site.data.keyword.conversationshort}}
...
For more information about related features and details, see the following resources:
 ...
 - [Calling a service before processing a message for {{site.data.keyword.conversationshort}}](/docs/watson-assistant?topic=watson-assistant-webhook-pre-watson-assistant)
...
This example shows how to translate a message response back to the customer's language. It works only if you perform the steps in [Example 2](/docs/watson-assistant?topic=watson-assistant-webhook-pre-watson-assistant#pre-example-2-watson-assistant) to define a pre-message webhook that translates the original message into English.
